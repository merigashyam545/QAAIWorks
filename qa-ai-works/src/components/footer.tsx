...
export function Footer() {
  return <footer className="footer"><div className="shell footer-grid">
    <div><Link href="/" className="brand official-brand footer-brand" aria-label="QA AI Works home"><Image src="/qa-ai-works-logo.png" alt="QA AI Works" width={2068} height={760} /></Link><p>Quality Engineering transformation for the AI era.</p></div>
