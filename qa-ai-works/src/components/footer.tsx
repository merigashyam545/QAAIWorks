...
export function Footer() {
  return <footer className="footer"><div className="shell footer-grid">
    ...
    <div><h3>Expertise</h3><Link href="/services">Services</Link><Link href="/ai-quality-engineering">AI & Quality Engineering</Link><Link href="/ai-qa-readiness">AI QA Readiness</Link><Link href="/ai-qa-lab">AI QA Lab</Link><Link href="/accelerator">Accelerator</Link></div>
  ...
  </div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} QA AI Works</span><span><Link href="/privacy">Privacy</Link> · Strategy · Engineering · Intelligence</span></div></footer>;
}
